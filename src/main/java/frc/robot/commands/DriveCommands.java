...
public class DriveCommands {
  ...
  private static final double AUTO_MAX_POWER = .25;
  private static final double AUTO_RADIUS = .05;
  ...
  public static Command joystickDrive(Drive drive, DoubleSupplier xSupplier,
      DoubleSupplier ySupplier, DoubleSupplier omegaSupplier, BooleanSupplier robotRelativeSupplier,
      DoubleSupplier visionTx, BooleanSupplier leftAlign, BooleanSupplier rightAlign,
