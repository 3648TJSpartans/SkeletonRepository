...
/*
 * The IO file creates a skeleton for the third file with most of the logic. If a subsystem could
 * have two variants, such as one with one motor and one with two, both could run through the same
 * IO structure.
 */
