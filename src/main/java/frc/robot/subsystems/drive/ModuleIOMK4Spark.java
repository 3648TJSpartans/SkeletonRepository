 ...
 */
public class ModuleIOMK4Spark implements ModuleIO {
        ...
        public ModuleIOMK4Spark(int module) {
                ...
                driveConfig.closedLoop.feedbackSensor(FeedbackSensor.kPrimaryEncoder).pidf(driveKp,
                                0.0, driveKd, 0.0);
        ...
        public void setDriveVelocity(double velocityRadPerSec) {
                double ffVolts = driveKs * Math.signum(velocityRadPerSec)
