...
public class SimpleMotorConstants {
    ...
    /*
     * TunableNumbers allow constants that need to be adjusted to be tuned while the robot is
     * running.
     */

    public static final TunableNumber speed1 = new TunableNumber("simpleMotor/speed1", 0);
    public static final TunableNumber speed2 = new TunableNumber("simpleMotor/speed2", 0.1);
}
