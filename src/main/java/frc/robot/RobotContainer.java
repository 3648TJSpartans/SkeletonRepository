...
public class RobotContainer {
        ...
        private void configureAutos() {
                ...
                Command relOutAuto = new RelCmd(m_relEncoder, RelEncoderConstants.setpoint1.get());
                Command absOutAuto = new AbsCmd(m_absEncoder, AbsEncoderConstants.setpoint1.get());
                Command simpleMotorAuto = new SimpleMotorCmd(m_simpleMotor,
                                SimpleMotorConstants.speed1.get());
        ...
        public void configureSimpleMotor() {
                Command simpleForward = new SimpleMotorCmd(m_simpleMotor,
                                SimpleMotorConstants.speed1.get());
                Command simpleBackward = new SimpleMotorCmd(m_simpleMotor,
                                -SimpleMotorConstants.speed1.get());
        ...
        public void configureAbsoluteEncoder() {
                ...
                Command exampleAbs1 = new AbsCmd(m_absEncoder, AbsEncoderConstants.setpoint1.get());
                Command exampleAbs2 = new AbsCmd(m_absEncoder, AbsEncoderConstants.setpoint2.get());
