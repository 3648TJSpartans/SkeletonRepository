...
public class LimelightHelpers {
    ...
    public static class RawDetection {
        ...
        public RawDetection(int classId, double txnc, double tync, double ta, double corner0_X,
                double corner0_Y, double corner1_X, double corner1_Y, double corner2_X,
                double corner2_Y, double corner3_X, double corner3_Y) {
    ...
    public static class PoseEstimate {
        ...
        public PoseObservation getAsObservartion() {
            return new PoseObservation(timestampSeconds, new Pose3d(pose),
                    rawFiducials.length > 0 ? 0.0 : rawFiducials[0].ambiguity, tagCount, avgTagDist,
    ...
    private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName,
        ...
        return new PoseEstimate(pose, adjustedTimestamp, latency, tagCount, tagSpan, tagDist,
                tagArea, rawFiducials, isMegaTag2);
    }
    ...
    public static DoubleArrayEntry getLimelightDoubleArrayEntry(String tableName,
            String entryName) {
    ...
    private static void SetRobotOrientation_INTERNAL(String limelightName, double yaw,
            double yawRate, double pitch, double pitchRate, double roll, double rollRate,
            boolean flush) {
