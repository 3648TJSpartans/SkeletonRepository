...
public class AutonConstants {
        ...
        public static final double thetakP = 0.0;
        ...
        public static final double thetaTolerance = Units.degreesToRadians(0);
        public static final double ffMinRadius = 0.2;
        public static final double ffMaxRadius = 0.6;

        public static class PoseConstants {
                public final static Pose2d examplePose = new Pose2d(0, 0, Rotation2d.fromDegrees(0));
                public final static Pose2d examplePose2 = new Pose2d(1, 1, Rotation2d.fromDegrees(90));
